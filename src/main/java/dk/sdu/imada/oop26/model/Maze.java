...
public class Maze {
    ...
    public static final String[] TILE_MAP = {
            ...
            "xxxx     x       x                       x   x    x     xxxx",
            "x        x       x   x                x  x   x    x        x",
            "x   xxx  x  x    x   x  xxxx    xxxx  x  x   x    x  xxx   x",
            "O   xxx  x  x    x   x  x          x  x  x   x    x  xxx   O",
    ...
    public static boolean isWall(int row, int col) { // Check if the tile at (row, col) is a wall
